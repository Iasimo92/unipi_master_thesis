...
\begin{figure}[h]
	...
	\caption{Σνάρτηση \en{firstPage} στο αρχείο \en{views.py} }
\end{figure}
...
\begin{figure}[h]
	...
	\caption{ Έξοδος τερματικού κατά την εκκίνηση του \en{Django server}}
\end{figure}
...
\begin{figure}[htb]
	...
	\caption{Αρχικοποίηση της συσκευής μέσω της κλάσης \en{Device}}
\end{figure}
...
\begin{figure}[h]
	...
	\caption{Μεταβολή της \en{IP} διεύθυνσης λόγω διαμόρφωσης}
\end{figure}

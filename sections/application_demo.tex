...
Η συνάρτηση επιτρέπει τη σύνδεση σε μια δικτυακή συσκευή, την ανάκτηση των στατιστικών των διεπαφών της και την παρουσίαση αυτών των δεδομένων σε μια ιστοσελίδα. Αυτό επιτυγχάνεται επιλέγοντας \en{Interface Statistics} από το αρχικό μενού. Αυτό μας δρομολογεί στο \en{web page} του σχήματος 7.11.
...
\en{backup} και με αυτό πέρνουμε το αποτέλεσμα της εικόνας 7.13.

\noindent Ουσιαστικά είναι σε \en{text} αρχείο το λεγόμενο \en{running config} της συσκευής
...
Η διαμόρφωση \en{IP} διεύθυσης γίνεται δίνοντας τα παρακάτω στοιχεία σαν είσοδο όπως φαίνεται στο σχήμα 7.14. Δίνοτας το \en{hostname,username,password,Interface,ipaddress} και \en{subnetmask} καταφέρνει να παραμετροποιήσει IP διεύθυνση σε συγκεκριμένο \en{interface}. Και καταφέρνει και αλλάζει την διέυθυνση. 
